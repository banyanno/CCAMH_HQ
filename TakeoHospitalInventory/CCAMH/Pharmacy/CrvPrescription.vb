...
Public Class CrvPrescription
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "KTGSYS.CrvPrescription.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrvPrescription
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrvPrescription = New CrvPrescription()
        rpt.Site = Me.Site
        Return rpt
    End Function
