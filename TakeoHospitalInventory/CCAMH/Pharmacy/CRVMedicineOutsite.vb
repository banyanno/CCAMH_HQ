...
Public Class CRVMedicineOutsite
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "KTGSYS.CRVMedicineOutsite.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRVMedicineOutsite
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRVMedicineOutsite = New CRVMedicineOutsite()
        rpt.Site = Me.Site
        Return rpt
    End Function
