...
Public Class CCAHM_CLIENT_REPORT_AUDITV1
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CCAHM_CLIENT_REPORT_AUDITV1.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "KTGSYS.CCAHM_CLIENT_REPORT_AUDITV1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCCAHM_CLIENT_REPORT_AUDITV1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CCAHM_CLIENT_REPORT_AUDITV1 = New CCAHM_CLIENT_REPORT_AUDITV1()
        rpt.Site = Me.Site
        Return rpt
    End Function
