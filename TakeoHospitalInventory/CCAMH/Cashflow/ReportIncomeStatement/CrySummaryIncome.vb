...
Public Class CrySummaryIncome
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "KTGSYS.CrySummaryIncome.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrySummaryIncome
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrySummaryIncome = New CrySummaryIncome()
        rpt.Site = Me.Site
        Return rpt
    End Function
