...
Public Class CRVIncomeDetailV2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "KTGSYS.CRVIncomeDetailV2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRVIncomeDetailV2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRVIncomeDetailV2 = New CRVIncomeDetailV2()
        rpt.Site = Me.Site
        Return rpt
    End Function
