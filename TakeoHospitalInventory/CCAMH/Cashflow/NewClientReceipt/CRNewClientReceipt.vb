...
Public Class CRNewClientReceipt
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "KTGSYS.CRNewClientReceipt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRNewClientReceipt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRNewClientReceipt = New CRNewClientReceipt()
        rpt.Site = Me.Site
        Return rpt
    End Function
