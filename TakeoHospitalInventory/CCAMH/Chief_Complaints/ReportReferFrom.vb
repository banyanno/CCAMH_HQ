...
Public Class ReportReferFrom
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "KTGSYS.ReportReferFrom.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReportReferFrom
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReportReferFrom = New ReportReferFrom()
        rpt.Site = Me.Site
        Return rpt
    End Function
