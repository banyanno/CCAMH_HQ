...
Public Class ReportFastTracking
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "KTGSYS.ReportFastTracking.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReportFastTracking
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReportFastTracking = New ReportFastTracking()
        rpt.Site = Me.Site
        Return rpt
    End Function
