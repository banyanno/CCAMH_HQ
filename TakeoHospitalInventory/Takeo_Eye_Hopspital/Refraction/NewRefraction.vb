Public Class NewRefraction
    ...
    Private Sub BtnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnSave.Click
        ...
        If lblSaveOption.Text = "0" Then
            If DARefraction.CheckExistingPatient(TxtPatientNo.Text, RefrationDate.Value) > 0 Then
                ...
                Exit Sub
            End If
            If MessageBox.Show("Do you want to save new refraction?", "Save", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = System.Windows.Forms.DialogResult.Yes Then
            ...
            End If
        Else
            If MessageBox.Show("Do you want to update refraction?", "Save", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = System.Windows.Forms.DialogResult.Yes Then
    ...
    Private Sub BtnVAReading_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnVAReading.Click
        ...
        If VAReading.ShowDialog = System.Windows.Forms.DialogResult.OK Then
            RefreshVAReading()
        End If
    End Sub
    ...
    Private Sub BtnGlassesAxis_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnGlassesAxis.Click
        ...
        If Axis.ShowDialog = System.Windows.Forms.DialogResult.OK Then
            RefreshAxis()
        End If
    End Sub
