    ...
    Private Sub BtnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnSave.Click
        ...
        If LblSaveOption.Text = "0" Then
            If CheckPatientNo() = False Then
                Exit Sub
            End If
            If MessageBox.Show("Do you want save new Mo.Po.Tyso's patient?", "Save", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = System.Windows.Forms.DialogResult.Yes Then
            ...
            End If
        Else
            If MessageBox.Show("Do you want update Mo.Po.Tyso's patient?", "Update", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = System.Windows.Forms.DialogResult.Yes Then
