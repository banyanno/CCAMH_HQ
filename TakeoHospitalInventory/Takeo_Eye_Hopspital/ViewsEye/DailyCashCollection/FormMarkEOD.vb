    ...
    Private Sub BtnSettingMarkEOD_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnSettingMarkEOD.Click
        ...
        If LblSaveOption.Text = "0" Then
            If DA_BusDays.CheckMarkEODExist(DateNewBusinessDay.Value.Date, GetDateServer.Date) = 0 Then
                If MessageBox.Show("Do you want to mark new business day?", "Mark EOD", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = System.Windows.Forms.DialogResult.Yes Then
                    '' Get Current day-1 
            ...
            End If
        Else
            If MessageBox.Show("Do you want to update business day?", "Mark EOD", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = System.Windows.Forms.DialogResult.Yes Then
