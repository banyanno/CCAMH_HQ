        ...
        Else
            If LblReceiveAbleID.Text = "0" Then
                If MAccountReceivable.CheckIDAccDate(Me.cboAccountName.SelectedValue.ToString, Format(Me.dtpDate.Value, "MM/dd/yyyy")) = True Then
                    If MessageBox.Show("Do you want save new value's account recieveabl?", "Save", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = System.Windows.Forms.DialogResult.Yes Then
