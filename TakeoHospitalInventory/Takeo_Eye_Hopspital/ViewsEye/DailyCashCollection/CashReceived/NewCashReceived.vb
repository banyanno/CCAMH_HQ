    ...
    Sub SaveAndUpdateReceiptOther()
        ...
        Else
            If lblSaveOption.Text = "0" Then
                ...
                If MessageBox.Show("Do you want save new other receipt?", "Other Receipt", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = System.Windows.Forms.DialogResult.Yes Then
                ...
                End If
            Else
                If MessageBox.Show("Do you want update receipt?", "Other Receipt", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = System.Windows.Forms.DialogResult.Yes Then
                    MainForm.StatusLoading(True)
                    Dim tblTem As DataTable = DA_Patient.FindPatientNo(EmptyString(TxtPatientNo.Text))
                    If tblTem.Rows.Count > 0 Then
                        For Each rows In tblTem.Rows
