Public Class ClientList
    ...
    Private Sub btnNewClient_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnNewClient.Click
        ...
        If ClientInfo.ShowDialog = System.Windows.Forms.DialogResult.OK Then
            RefreshClient()
        End If
    End Sub
    ...
    Private Sub BtnDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnDelete.Click
        If GridClient.SelectedItems.Count = 0 Then Exit Sub
        If MessageBox.Show("Do you want to delete this client?", "Delete", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = System.Windows.Forms.DialogResult.Yes Then
