Public Class FormCashReceive
    ...
    Private Sub BtnNewReceiptOther_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnNewReceiptOther.Click
        ...
        If OtherReceived.ShowDialog = System.Windows.Forms.DialogResult.OK Then
        ...
        Else
            ...
            If Val_PreviewData = 2 Then
                Try
                    ...
                    If MessageBox.Show("Do you want to print preview?", "Print", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = System.Windows.Forms.DialogResult.Yes Then
    ...
    Private Sub BtnDeleteReceipt_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnDeleteReceipt.Click
        If GridOtherReceipt.SelectedItems.Count = 0 Then Exit Sub
        If MessageBox.Show("Do you want delete this receipt", "Delete", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = System.Windows.Forms.DialogResult.Yes Then
