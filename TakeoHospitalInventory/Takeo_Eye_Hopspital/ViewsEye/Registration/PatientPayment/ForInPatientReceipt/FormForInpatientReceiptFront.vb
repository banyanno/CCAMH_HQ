...
Public Class FormForInpatientReceiptFront
    ...
    Function SaveInPatientReceipt() As Boolean
        ...
        If MCashReceipt.CheckDuplicateReceiptNo(Me.txtReceiptNumber.Text, "tblPatientReceipt") = True Then
            LoadNewReceiptNo()
        End If
        If MessageBox.Show("Do you  want to save these information?", "Save confirm", MessageBoxButtons.YesNo, MessageBoxIcon.Information, MessageBoxDefaultButton.Button1) = System.Windows.Forms.DialogResult.Yes Then
