Public Class NewConsuling
    ...
    Private Sub BtnOffer_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnOffer.Click
        ...
        If NOffer.ShowDialog() = System.Windows.Forms.DialogResult.OK Then
            With LsGive
                .Items.Clear()
                For Each row As DataRow In DA_Org_Offer.GetData
                    .Items.Add(row("OFFER"))
    ...
    Private Sub BtnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnSave.Click
        ...
        If LblSaveOption.Text = "0" Then
            If RadForInPatient.Checked = True Then
                ...
                End If
            End If
            If MessageBox.Show("Do you want save new consulting?", "Save", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = System.Windows.Forms.DialogResult.Yes Then
        ...
        Else
            If MessageBox.Show("Do you want update consulting?", "Update", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = System.Windows.Forms.DialogResult.Yes Then
