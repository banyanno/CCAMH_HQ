Public Class AppointmentParameter
    ...
    Private Sub BtnSaveNew_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnSaveNew.Click
        ...
        If LblSaveOption.Text = "0" Then
            If MessageBox.Show("Do you want to save new appointment parameter?", "App para", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = System.Windows.Forms.DialogResult.Yes Then
    ...
    Private Sub BtnUpdate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnUpdate.Click
        If LblSaveOption.Text <> "0" Then
            If MessageBox.Show("Do you want to update  appointment parameter?", "App para", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = System.Windows.Forms.DialogResult.Yes Then
    ...
    Private Sub BtnDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnDelete.Click
        If GridAppPara.SelectedItems.Count = 0 Then Exit Sub
        If MessageBox.Show("Do you want to delete appointment parameter?", "App para", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = System.Windows.Forms.DialogResult.Yes Then
