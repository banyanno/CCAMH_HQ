Public Class DRMedical
    ...
    Private Sub BtnDr_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnDr.Click
        ...
        If NDr.ShowDialog = System.Windows.Forms.DialogResult.OK Then
            RefreshDr()
        End If
    ...
    Private Sub BtnDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnDelete.Click
        If GridDr.SelectedItems.Count = 0 Then Exit Sub
        If MessageBox.Show("Do you want delete?", "Delete", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = System.Windows.Forms.DialogResult.Yes Then
