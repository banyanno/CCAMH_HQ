    ...
    Private Sub BtnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnSave.Click
        ...
        Try
            ...
            If ValidateTextField(TxtLoginName, "Login name", ErrUser) = False Then
                Exit Sub
            End If
            If DAUser.CheckExistingUserName(TxtUserName.Text.ToUpper) > 1 Then
            ...
            System.Windows.Forms.DialogResult.Yes Then
                ...
                user.user_function = TxtFunction.Text
                user.user_description = TxtDescription.Text
                user.create_date = Now.Date
