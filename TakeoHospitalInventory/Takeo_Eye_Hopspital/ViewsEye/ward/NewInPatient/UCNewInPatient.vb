Public Class UCNewInPatient
    ...
    Private Sub BtnDailyInpatient_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnDailyInpatient.Click
        FindAction("", "", "")
        If MessageBox.Show("Do you want save daily in-patient record?", "Save", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = System.Windows.Forms.DialogResult.Yes Then
