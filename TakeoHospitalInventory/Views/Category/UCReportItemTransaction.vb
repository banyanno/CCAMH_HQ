...
Public Class UCReportItemTransaction
    ...
    Private CRVItemDialy As New CrCategoryItemDailyTransactionReport
    Private CRVItemTransacionReport As New CrCategoryItemDailyTransactionReportV1
        ...
        Else
            ...
            If RadDateToDate.Checked = True Then
                ...
                If DEPART_ID = 28 Then
                    ...
                    CRVItemTransacionReport.SetDataSource(departTranDataByCateID)
                    CRVItemTransacionReport.SetParameterValue("fromDate", Format(DFrom, "dd/MMM/yyyy"))
                    CRVItemTransacionReport.SetParameterValue("toDate", Format(DTo, "dd/MMM/yyyy"))
                    CRVItemTransacionReport.SetParameterValue("category", "Category :" & cbCate.Text)
                    CRVItemTransacionReport.SetParameterValue("depart", cbDepart.Text)
                Else
                    ...
                    CRVItemTransacionReport.SetParameterValue("toDate", Format(DTo, "dd/MMM/yyyy"))
                    CRVItemTransacionReport.SetParameterValue("category", "Category :" & cbCate.Text)
                    CRVItemTransacionReport.SetParameterValue("depart", DEPART_NAME)
                End If
                CRVItemTransaction.ReportSource = CRVItemTransacionReport
            ...
            If RadDaily.Checked = True Then
                ...
                If DEPART_ID = 28 Then
                    departTranDataByCateID = VRunEndofDayResultDataAdapter.GetDepartTranDataByCateID(Val(cbDepart.SelectedValue), cbCate.SelectedValue, DFrom, DTo)
                    CRVItemDialy.SetDataSource(departTranDataByCateID)
                    CRVItemDialy.SetParameterValue("fromDate", Format(DFrom, "dd/MMM/yyyy"))
                    CRVItemDialy.SetParameterValue("toDate", Format(DTo, "dd/MMM/yyyy"))
                    CRVItemDialy.SetParameterValue("category", "Category :" & cbCate.Text)
                    CRVItemDialy.SetParameterValue("depart", cbDepart.Text)
                Else
                    departTranDataByCateID = VRunEndofDayResultDataAdapter.GetDepartTranDataByCateID(Val(DEPART_ID), cbCate.SelectedValue, DFrom, DTo)
                    ...
                    CRVItemDialy.SetParameterValue("toDate", Format(DTo, "dd/MMM/yyyy"))
                    CRVItemDialy.SetParameterValue("category", "Category :" & cbCate.Text)
                    CRVItemDialy.SetParameterValue("depart", DEPART_NAME)
                End If

                CRVItemTransaction.ReportSource = CRVItemDialy
                CRVItemTransaction.Refresh()
            End If
        ...
        Else
            ...
            If RadDateToDate.Checked = True Then
                ...
                If DEPART_ID = 28 Then
                    ...
                    CRVItemTransacionReport.SetDataSource(departTranDataByItemID)
                    CRVItemTransacionReport.SetParameterValue("fromDate", Format(DFrom, "dd/MMM/yyyy"))
                    CRVItemTransacionReport.SetParameterValue("toDate", Format(DTo, "dd/MMM/yyyy"))
                    CRVItemTransacionReport.SetParameterValue("category", cbItems.Text)
                    CRVItemTransacionReport.SetParameterValue("depart", cbDepart.Text)
                Else
            ...
            If RadDaily.Checked = True Then
                ...
                If DEPART_ID = 28 Then
                    departTranDataByItemID = VRunEndofDayResultDataAdapter.GetDepartTranDataByItemID(Val(cbDepart.SelectedValue), cbItems.SelectedValue, DFrom, DTo)
                    CRVItemDialy.SetDataSource(departTranDataByItemID)
                    CRVItemDialy.SetParameterValue("fromDate", Format(DFrom, "dd/MMM/yyyy"))
                    CRVItemDialy.SetParameterValue("toDate", Format(DTo, "dd/MMM/yyyy"))
                    CRVItemDialy.SetParameterValue("category", cbItems.Text)
                    CRVItemDialy.SetParameterValue("depart", cbDepart.Text)
                Else
                    departTranDataByItemID = VRunEndofDayResultDataAdapter.GetDepartTranDataByItemID(Val(DEPART_ID), cbItems.SelectedValue, DFrom, DTo)
                    CRVItemDialy.SetDataSource(departTranDataByItemID)
    ...
    Sub PreviewByDepart()
        ...
        Else
                ...
                If DEPART_ID = 28 Then
                    If cbDepart.SelectedValue = 26 Then
                        ...
                        Else
                            ...
                            CRVItemTransacionReport.SetDataSource(departTranDataByDepartID)
                            CRVItemTransacionReport.SetParameterValue("fromDate", Format(DFrom, "dd/MMM/yyyy"))
                            CRVItemTransacionReport.SetParameterValue("toDate", Format(DTo, "dd/MMM/yyyy"))
                            CRVItemTransacionReport.SetParameterValue("category", "") 'cbCate.Text)
                            CRVItemTransacionReport.SetParameterValue("depart", cbDepart.Text)
                            CRVItemTransaction.ReportSource = CRVItemTransacionReport
                            CRVItemTransaction.Refresh()
                        End If
            ...
            If RadDaily.Checked = True Then
                ...
                If DEPART_ID = 28 Then
                    departTranDataByDepartID = VRunEndofDayResultDataAdapter.GetDepartTranDataByDepartID(Val(cbDepart.SelectedValue), DFrom, DTo)
                    CRVItemDialy.SetDataSource(departTranDataByDepartID)
                    CRVItemDialy.SetParameterValue("fromDate", Format(DFrom, "dd/MMM/yyyy"))
                    CRVItemDialy.SetParameterValue("toDate", Format(DTo, "dd/MMM/yyyy"))
                    CRVItemDialy.SetParameterValue("category", "") 'cbCate.Text)
                    CRVItemDialy.SetParameterValue("depart", cbDepart.Text)
                Else
                    departTranDataByDepartID = VRunEndofDayResultDataAdapter.GetDepartTranDataByDepartID(Val(DEPART_ID), DFrom, DTo)
    ...
    Private Sub rbDaily_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles RadDaily.CheckedChanged
        If RadDaily.Checked = True Then
            IsDailyReport = True
        Else
            IsDailyReport = False
