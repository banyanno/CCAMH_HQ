Public Class frmCategory
    ...
    Private Sub btnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        If lblSaveOption.Text = "0" Then
            If MessageBox.Show("Do you want save new Category ?", "Save", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = System.Windows.Forms.DialogResult.Yes Then
        ...
        Else ' Update vendor to database
            If MessageBox.Show("Do you want save Category ?", "Save", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = System.Windows.Forms.DialogResult.Yes Then
