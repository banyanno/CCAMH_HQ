...
Public Class frmItemPrice
    ...
    Private Sub BtnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnSave.Click
        ...
        If lblSaveOption.Text = "0" Then
            ...
            If MessageBox.Show("Do you want save new item price ?" & txtItemName.Text & " ?", "Save", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = System.Windows.Forms.DialogResult.Yes Then
        ...
        Else
            If MessageBox.Show("Do you want save item price " & txtItemName.Text & " ?", "Save", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = System.Windows.Forms.DialogResult.Yes Then
