Public Class frmChemical
    ...
    Dim MainItemAtri As MainFormAttribute
    ...
    Public Sub New(ByVal mainChemical As UCChemical)
        ...
        ' Add any initialization after the InitializeComponent() call.
    End Sub
    Sub New(ByVal MainItemAtri As MainFormAttribute)

        ' This call is required by the Windows Form Designer.
        InitializeComponent()
        Me.MainItemAtri = MainItemAtri
        ' Add any initialization after the InitializeComponent() call.
    ...
    Private Sub btnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        If lblSaveOption.Text = "0" Then
            If MessageBox.Show("Do you want save new chemical ?", "Save", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = System.Windows.Forms.DialogResult.Yes Then
        ...
        Else
            ...
            If MessageBox.Show("Do you want save chemical ?", "Save", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = System.Windows.Forms.DialogResult.Yes Then
                chemical = chemicalRepo.GetChemicalByID(chemicalID)
                chemical.ChemicalName = txtChemicalName.Text
                chemical.Description = rtbDescript.Text
