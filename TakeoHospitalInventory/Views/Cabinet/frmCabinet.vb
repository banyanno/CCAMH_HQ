Public Class frmCabinet
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        'Save new Cabinet
        If lblSaveOption.Text = "0" Then
            If MessageBox.Show("Do you want save new Cabinet ?", "New", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = System.Windows.Forms.DialogResult.Yes Then
        ...
        Else ' Save update Cabinet
            If MessageBox.Show("Do you want save Cabinet ?", "Save", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = System.Windows.Forms.DialogResult.Yes Then
