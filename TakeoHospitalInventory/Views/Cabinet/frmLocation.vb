Public Class frmLocation
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        'Save new Cabinet
        If lblSaveOption.Text = "0" Then
            If MessageBox.Show("Do you want save new Location ?", "New", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = System.Windows.Forms.DialogResult.Yes Then
        ...
        Else ' Save update Cabinet
            ...
            If MessageBox.Show("Do you want save Location ?", "Save", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = System.Windows.Forms.DialogResult.Yes Then
