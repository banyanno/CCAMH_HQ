Public Class UIShowAllItemBalanceInDeppartment
    ...
    Sub New(ByVal MainCCAMH As MainAppKTG)

        ' This call is required by the Windows Form Designer.
        InitializeComponent()
        Me.MainCCAMH = MainCCAMH
        ' Add any initialization after the InitializeComponent() call.
    ...
    Private Sub BgCheckRunEOD_RunWorkerCompleted(ByVal sender As System.Object, ByVal e As System.ComponentModel.RunWorkerCompletedEventArgs) Handles BgCheckRunEOD.RunWorkerCompleted
        ...
        BtnRefreshStockInDep.Enabled = True
        Application.DoEvents()
        MainCCAMH.StatusLoading(False, "")
    End Sub
    ...
    Private Sub BgCheckRunEOD_DoWork(ByVal sender As System.Object, ByVal e As System.ComponentModel.DoWorkEventArgs) Handles BgCheckRunEOD.DoWork
        MainCCAMH.StatusLoading(True, "Loanding")
    ...
    Private Sub BtnRefreshStockInDep_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnRefreshStockInDep.Click
        BtnRefreshStockInDep.Enabled = False
    ...
    Private Sub BtnPrintReport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnPrintReport.Click
        ...
        If FHosItemBalance.ShowDialog() = System.Windows.Forms.DialogResult.OK Then
