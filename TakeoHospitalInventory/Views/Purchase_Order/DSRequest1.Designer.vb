...
Partial Public Class DSRequest
    ...
    Partial Public Class VRequestItemDetailDataTable
        ...
        Public Overloads Function AddVRequestItemDetailRow( _
                    ...
                    ByVal RequestItemnote As String) As VRequestItemDetailRow
            Dim rowVRequestItemDetailRow As VRequestItemDetailRow = CType(Me.NewRow,VRequestItemDetailRow)
            Dim columnValuesArray() As Object = New Object() {ItemID, Quantity, ItemCode, ItemName, ItemDescription, Barcode, LabourFacName, ContainerName, ItemUnitName, CateName, ResponseQuantity, Comment, UnitsInStock, POStatus, IsOrginalItemReq, RequestDetailID, RequestItemnote}
    ...
    Partial Public Class VUsedWithUsedDetailDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddVUsedWithUsedDetailRow(ByVal DepartName As String, ByVal UsedDate As Date, ByVal UsedDepartID As Integer, ByVal Barcode As String, ByVal UsedDescription As String, ByVal ItemName As String, ByVal UsedQuantity As Integer, ByVal ItemID As Decimal, ByVal ItemUnitName As String, ByVal ContainerName As String, ByVal CateName As String, ByVal DepartID As Integer, ByVal UnitsInStock As Integer) As VUsedWithUsedDetailRow
            Dim rowVUsedWithUsedDetailRow As VUsedWithUsedDetailRow = CType(Me.NewRow,VUsedWithUsedDetailRow)
            Dim columnValuesArray() As Object = New Object() {DepartName, UsedDate, UsedDepartID, Barcode, UsedDescription, ItemName, UsedQuantity, ItemID, ItemUnitName, ContainerName, CateName, DepartID, UnitsInStock}
    ...
    Partial Public Class VRequestItemDetailRow
        ...
        Public Property RequestItemnote() As String
            Get
                Try 
                    Return CType(Me(Me.tableVRequestItemDetail.RequestItemnoteColumn),String)
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("The value for column 'RequestItemnote' in table 'VRequestItemDetail' is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableVRequestItemDetail.RequestItemnoteColumn) = value
            End Set
        End Property
        ...
        Public Function IsRequestItemnoteNull() As Boolean
            Return Me.IsNull(Me.tableVRequestItemDetail.RequestItemnoteColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Sub SetRequestItemnoteNull()
            Me(Me.tableVRequestItemDetail.RequestItemnoteColumn) = Global.System.Convert.DBNull
        End Sub
    End Class
    ...
    Partial Public Class VUsedWithUsedDetailRow
        ...
        Public Property UnitsInStock() As Integer
            Get
                Try 
                    Return CType(Me(Me.tableVUsedWithUsedDetail.UnitsInStockColumn),Integer)
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("The value for column 'UnitsInStock' in table 'VUsedWithUsedDetail' is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableVUsedWithUsedDetail.UnitsInStockColumn) = value
            End Set
        End Property
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Function IsUnitsInStockNull() As Boolean
            Return Me.IsNull(Me.tableVUsedWithUsedDetail.UnitsInStockColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Sub SetUnitsInStockNull()
            Me(Me.tableVUsedWithUsedDetail.UnitsInStockColumn) = Global.System.Convert.DBNull
        End Sub
    End Class
...
Namespace DSRequestTableAdapters
    ...
    Partial Public Class VRequestItemDetailTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0) = New Global.System.Data.SqlClient.SqlCommand()
            Me._commandCollection(0).Connection = Me.Connection
            Me._commandCollection(0).CommandText = "SELECT        ItemID, Quantity, ItemCode, ItemName, ItemDescription, Barcode, Lab"& _ 
                "ourFacName, ContainerName, ItemUnitName, CateName, ResponseQuantity, Comment, Un"& _ 
                "itsInStock, POStatus, IsOrginalItemReq, RequestDetailID, "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                     "& _ 
                "    RequestItemnote"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM            VRequestItemDetail"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(1) = New Global.System.Data.SqlClient.SqlCommand()
            Me._commandCollection(1).Connection = Me.Connection
            Me._commandCollection(1).CommandText = "SELECT        Barcode, CateName, Comment, ContainerName, IsOrginalItemReq, ItemCo"& _ 
                "de, ItemDescription, ItemID, ItemName, ItemUnitName, LabourFacName, POStatus, Qu"& _ 
                "antity, RequestDetailID, ResponseQuantity, UnitsInStock, "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                     "& _ 
                "    RequestItemnote"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM            VRequestItemDetail"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE        (RequestID"& _ 
                " = @RequestID)"
            Me._commandCollection(1).CommandType = Global.System.Data.CommandType.Text
    ...
    Partial Public Class VUsedWithUsedDetailTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0) = New Global.System.Data.SqlClient.SqlCommand()
            Me._commandCollection(0).Connection = Me.Connection
            Me._commandCollection(0).CommandText = "SELECT        DepartName, UsedDate, UsedDepartID, Barcode, UsedDescription, ItemN"& _ 
                "ame, UsedQuantity, ItemID, ItemUnitName, ContainerName, CateName, DepartID, Unit"& _ 
                "sInStock"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM            VUsedWithUsedDetail"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(1) = New Global.System.Data.SqlClient.SqlCommand()
            Me._commandCollection(1).Connection = Me.Connection
            Me._commandCollection(1).CommandText = "SELECT        Barcode, ItemName, SUM(UsedQuantity) AS TotalItemUsed, ItemID, Item"& _ 
                "UnitName, ContainerName, CateName, DepartID, UnitsInStock"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM            VUsed"& _ 
                "WithUsedDetail"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE        (UsedDate BETWEEN @From AND @To) AND (UsedDepartID "& _ 
                "= @UsedDepartID)"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"GROUP BY ItemID, ItemName, Barcode, ItemUnitName, ContainerNam"& _ 
                "e, CateName, DepartID, UnitsInStock"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"ORDER BY CateName"
            Me._commandCollection(1).CommandType = Global.System.Data.CommandType.Text
