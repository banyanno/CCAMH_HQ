...
Public Class frmReportViewer
    ...
    End Sub
    Public Sub PrintReceivedFrom()
        Dim DA_ReceivedItem As New DSAddMoreReceiveTableAdapters.V_CARITAS_REQTableAdapter
        Dim ReceivedItemTable As DataTable = DA_ReceivedItem.SelectReceivedByRequestID(CaritasRequestID)
        Dim CrvReceivedItem As New CRVReportDrugReceived
        CrvReceivedItem.SetDataSource(ReceivedItemTable)
        CRVReportViewer.ReportSource = CrvReceivedItem
        CRVReportViewer.Refresh()
    End Sub
