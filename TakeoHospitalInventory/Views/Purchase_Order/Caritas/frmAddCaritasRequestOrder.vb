...
Public Class frmAddCaritasRequestOrder
    ...
    Dim DA_CorrentStock As New DSHospitalRequestToCaritasTableAdapters.tblCentralInventoryTableAdapter
            ...
            Select Case labelStatus
                ...
                Case "OpenEdit"
                    ...
                    For Each aRow As DataRow In myDataTable.Rows
                        ...
                        dataRow("RequestItemnote") = aRow("RequestItemnote")
    ...
    Private Sub btnAddItemReDetail_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAddItemReDetail.Click
        ...
        If IsRequestExistingItem = True Then
            If ValidateTextField(TxtPercentAddmore, "", ErrRequest) = False Then Exit Sub
            Dim frmReqDetail As New frmRequestItemsDetail(Me)
            frmReqDetail.isDisplayItemInMainStock = True
            frmReqDetail.isCheckStockRequest = True
            frmReqDetail.stockDepartID = MAIN_STOCK_DEPART_ID
            frmReqDetail.isCaritasReqOrder = True
            frmReqDetail.ReqStatus = labelStatus
            frmReqDetail.LblAddMorePercent.Text = EmptyString(TxtPercentAddmore.Text)
            'If labelStatus = "OpenEdit" Then
            frmReqDetail.CaritasDataTable = CaritasDT
            '   End If

            If frmReqDetail.ShowDialog() = System.Windows.Forms.DialogResult.OK Then
                Me.ChDateFrom.Value = frmReqDetail.DateUsedFrom.Value
                Me.ChDateTo.Value = frmReqDetail.DateUsedTo.Value
                Select Case labelStatus
                    Case "Open"
                        DGVRequestItemsDetail.DataSource = frmReqDetail.CaritasDataTable
                    Case "OpenEdit"
                        DGVRequestItemsDetail.DataSource = frmReqDetail.CaritasDataTable
                End Select
            End If
    ...
    Private Sub btnRemoveItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnRemoveItem.Click
        With DGVRequestItemsDetail
            For Each rRow As DataGridViewRow In .SelectedRows
                If MessageBox.Show("Do you want delete item Request Detail ?", "Delete", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = System.Windows.Forms.DialogResult.Yes Then
                    .Rows.Remove(rRow)
                End If
            Next
        End With
    ...
    Private Function TotalEndingBalacne(ByVal ItID As Integer, ByVal dateFrom As Date, ByVal dTo As Date) As Integer
        ...
        Return EndBalance
    End Function
    Private Function TotalGetCurrentStock(ByVal ItemID As Integer, ByVal DepartID As Integer)
        Dim LastStock As Integer = 0
        LastStock = DA_CorrentStock.GetTotalStockByItemInDep(DepartID, ItemID)
        Return LastStock
    End Function
        ...
        If MessageBox.Show("Do you want save new Request Order ?", "Save", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = System.Windows.Forms.DialogResult.Yes Then
            ...
            Try
                ...
                For Each rRow As DataGridViewRow In DGVRequestItemsDetail.Rows
                    ...
                    Try
                        CaritasRequestDetail.RequestItemnote = rRow.Cells("RequestItemnote").Value
                    Catch ex As Exception
                        CaritasRequestDetail.RequestItemnote = ""
                    End Try
                    ...
                    EndBalance = TotalGetCurrentStock(rRow.Cells("cItemNo").Value, DEPART_ID) 'TotalGetCurrentStock(rRow.Cells("cItemNo").Value, DEPART_ID) ' TotalEndingBalacne(rRow.Cells("cItemNo").Value, ChDateFrom.Value.Date, ChDateTo.Value.Date)
                    ...
                    CaritasRequestDetail.Balance = EndBalance '(BeginStock + Recieve) - UsedInStock
    ...
    Sub SaveCaritasRequestOrderInStatusOpen()
        ...
        If MessageBox.Show("Do you want save new Request Order ?", "Save", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = System.Windows.Forms.DialogResult.Yes Then
            ...
            Try
                ...
                CaritasRequestOrder.RequestPercent = EmptyString(TxtPercentAddmore.Text)
                ...
                For Each rRow As DataGridViewRow In DGVRequestItemsDetail.Rows
                    ...
                    CaritasRequestDetail.IsReceive = False
                    CaritasRequestDetail.IsReady = False
                    CaritasRequestDetail.RequestItemnote = IIf(TypeOf rRow.Cells("RequestItemnote").Value Is DBNull, "", rRow.Cells("RequestItemnote").Value)
                    '--- Get item balance current stock
                    'Dim qMainStock = From mainStock In THIDataContext.getTHIDataContext.tblCentralInventories Where mainStock.ItemID = Val(rRow.Cells("cItemNo").Value)
    ...
    Private Sub TxtPercentAddmore_KeyPress(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles TxtPercentAddmore.KeyPress
