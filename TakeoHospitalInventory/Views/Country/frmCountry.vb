...
Public Class frmCountry
    ...
    Dim MainItemAttibe As MainFormAttribute
    Public countryID As Integer
    Public countryName As String

    Sub New(ByVal MainItemAttibe As MainFormAttribute)

        ' This call is required by the Windows Form Designer.
        InitializeComponent()
        MainItemAttibe = MainFormAttribute
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        If lblSaveOption.Text = "0" Then
            If MessageBox.Show("Do you want save new Country ?", "Save", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = System.Windows.Forms.DialogResult.Yes Then
        ...
        Else
            ...
            If MessageBox.Show("Do you want save country ?", "Save", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = System.Windows.Forms.DialogResult.Yes Then
