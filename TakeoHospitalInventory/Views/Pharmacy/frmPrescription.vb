...
Public Class frmPrescription
    ...
    Private Sub frmPrescription_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        End With
        With CboOpticalShop
            .DataSource = MedicineDataAdapter.GetItemDataByDepartID(SALE_DEPART_ID)
            .ValueMember = "ItemID"
            .DisplayMember = "ItemName"
            .AutoCompleteMode = AutoCompleteMode.Suggest
            .AutoCompleteSource = AutoCompleteSource.ListItems
    ...
    Sub AddItem()
        ...
        If MessageBox.Show("Do you want to add this medicine ?", "medicine", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = System.Windows.Forms.DialogResult.Yes Then
    ...
    Private Sub BtnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnSave.Click
        ...
        If LblSaveStatus.Text = "0" Then '--- Add new prescription
            If MessageBox.Show("Do you want save new Prescription ?", "Save", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = System.Windows.Forms.DialogResult.Yes Then
        ...
        Else    '--- Edit Prescription
            If MessageBox.Show("Do you want save Prescription ?", "Save", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = System.Windows.Forms.DialogResult.Yes Then
                THIDataContext.getTHIDataContext.Connection.Close()
                THIDataContext.getTHIDataContext.Connection.Open()
                Dim trans As DbTransaction = THIDataContext.getTHIDataContext.Connection.BeginTransaction
                THIDataContext.getTHIDataContext.Transaction = trans
    ...
    Private Sub GridPatientInformation_SelectionChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles GridPatientInformation.SelectionChanged
        Try
            ...
            'If FFindPatient.ShowDialog = System.Windows.Forms.DialogResult.OK Then
