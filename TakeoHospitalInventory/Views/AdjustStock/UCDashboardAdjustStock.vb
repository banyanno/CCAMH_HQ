...
Public Class UCDashboardAdjustStock
    ...
    End Sub
    Friend Sub FindAdjustByItemName(ItemName As String)
        gridAdjustmentHistory.DataSource = DepartAdjustStockDataAdapter.SelectAdjustByItemName(ItemName)
    End Sub
    ...
    Private Sub BtnApproved_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnApproved.Click
        ...
        If Not gridAdjustmentHistory.CurrentRow Is Nothing AndAlso gridAdjustmentHistory.CurrentRow.RowType = RowType.Record Then
            ...
            If MessageBox.Show("Are you sure to approve adjust item ?", "Save", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = System.Windows.Forms.DialogResult.Yes Then
                Try
                ...
                Finally
                    ...
                    MessageBox.Show("Approve adjust item successfully. Please run EOD", "Info", MessageBoxButtons.OK, MessageBoxIcon.Information)
    ...
    Private Sub BtnRevert_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnRevert.Click
        ...
        If Not gridAdjustmentHistory.CurrentRow Is Nothing AndAlso gridAdjustmentHistory.CurrentRow.RowType = RowType.Record Then
            ...
            If MessageBox.Show("Are you sure to revert adjust item ?", "Save", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = System.Windows.Forms.DialogResult.Yes Then
    ...
    Private Sub BtnFinItem_Click(sender As Object, e As EventArgs) Handles BtnFinItem.Click
        Dim FFindItem As New FormFindItemAdjust(Me)
        FFindItem.Show()
    End Sub
End Class
