...
Public Class frmAdjustStock
    ...
    Private Sub BtnOK_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnOK.Click
        ...
        If txtItemName.Text <> "" Then
            If MessageBox.Show("Do you want adjust quantity of item: " & txtItemName.Text & " ?", "Save", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = System.Windows.Forms.DialogResult.Yes Then
                ...
                Try
                    ...
                    myAdjustRecord.AdjustDate = GetDateServer().Date
