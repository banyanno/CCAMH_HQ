...
Public Class FrmAddItemInOpticalShop
    ...
    Sub AddItem()
        ...
        If MessageBox.Show("Do you want to add this item?", "Item", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = System.Windows.Forms.DialogResult.Yes Then
    ...
    Sub SearchItemByBarcode(ByVal ItemCodeNo As String)
        ...
        Else
            For Each row As DataRow In TblTemItem.Rows
                ...
                Dim TblDepartStock As New tblDeptStock
                TblDepartStock = itemDepartStockRepo.GetDepartStockByDepartIDAndItemID(SALE_DEPART_ID, CInt(LblItemID.Text))
