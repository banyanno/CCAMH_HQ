Public Class frmContainer
    ...
    Dim MainItemAttib As MainFormAttribute
    ...
    Private Sub btnCancel_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnCancel.Click
        Me.Close()
    End Sub
    Sub New(ByVal MainItemAttib As MainFormAttribute)

        ' This call is required by the Windows Form Designer.
        InitializeComponent()
        MainItemAttib = MainItemAttib
    ...
    Private Sub btnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        If lblSaveOption.Text = "0" Then
            If MessageBox.Show("Do you want save new Container ?", "Save", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = System.Windows.Forms.DialogResult.Yes Then
        ...
        Else
            ...
            If MessageBox.Show("Do you want save Container ?", "Save", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = System.Windows.Forms.DialogResult.Yes Then
