Public Class frmLabourFactory
    ...
    Dim MainItem As MainFormAttribute
    ...
    End Sub
    Sub New(ByVal MainItem As MainFormAttribute)

        ' This call is required by the Windows Form Designer.
        InitializeComponent()
        Me.MainItem = MainItemAtribute
        ' Add any initialization after the InitializeComponent() call.
    ...
    Private Sub btnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        If lblSaveOption.Text = "0" Then
            If MessageBox.Show("Do you want save new labouratory ?", "Save", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = System.Windows.Forms.DialogResult.Yes Then
        ...
        Else ' Update vendor to database
            ...
            If MessageBox.Show("Do you want save labouratory ?", "Save", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = System.Windows.Forms.DialogResult.Yes Then
