Public Class frmItemUnit
    ...
    Dim MainItemAttibute As MainFormAttribute
    Dim isNewChemicalFromItemForm As Boolean

    Sub New(ByVal MainItemAttibute As MainFormAttribute)

        ' This call is required by the Windows Form Designer.
        InitializeComponent()
        MainItemAttibute = MainFormAttribute
    ...
    Private Sub btnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        If lblSaveOption.Text = "0" Then
            If MessageBox.Show("Do you want save new ItemUnit ?", "Save", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = System.Windows.Forms.DialogResult.Yes Then
