...
Public Class FRMUpdateUserInventory
    ...
    Dim DAUser As New DSUserManagementTableAdapters.Department_UserTableAdapter
    ...
    Private Sub BtnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnSave.Click
        ...
        If ValidateCombobox(CboDepartment, "", ErrUpdateUser) = False Then Exit Sub
        If DAUser.CheckExistingUserName(TxtUserLogin.Text.ToUpper) > 1 Then
            MessageBox.Show("The user already existing in system. Please check again!", "User", MessageBoxButtons.OK, MessageBoxIcon.Error)
            Exit Sub
        End If
        ...
        If MessageBox.Show("Do you want update this user?", "Update", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = System.Windows.Forms.DialogResult.Yes Then
    ...
    Private Sub BtnRemove_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnRemove.Click
        With GridEODAccessRight
            For Each rRow As DataGridViewRow In .SelectedRows
                If MessageBox.Show("Do you want delete selected department ?", "Delete", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = System.Windows.Forms.DialogResult.Yes Then
                    .Rows.Remove(rRow)
                End If
            Next
        End With
