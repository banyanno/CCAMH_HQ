...
Public Class frmLoginInventory
    ...
    Private Sub frmLogin_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Label2.Text = "Copyright 2019. All rights reserved by KTG Version " & version.ToString '& "  " & GetDateServer.Date.ToString("MMM-yyyy")
        ' Timer1.Start()
    End Sub
