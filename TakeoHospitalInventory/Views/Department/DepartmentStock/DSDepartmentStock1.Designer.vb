...
Namespace DSDepartmentStockTableAdapters
    ...
    Partial Public Class VAdjustStockHistoryTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(8).CommandText = "SELECT        ItemName, Barcode, DepartName, CurrentQty, NewQty, Difference, Adju" & _
                "stDate, DepartID, ItemID, EmployeeName, UserName, Comment, IsApproval, ApprovalU" & _
                "serID, " & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "                         AdjustStockID, ExpireID" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "FROM            VAdju" & _
                "stStockHistory" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "WHERE" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "ItemName LIKE +'%'+ @ItemName +'%'"
            Me._commandCollection(8).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(8).Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@ItemName", Global.System.Data.SqlDbType.NVarChar, 150, Global.System.Data.ParameterDirection.Input, 0, 0, "ItemName", Global.System.Data.DataRowVersion.Current, False, Nothing, "", "", ""))
        End Sub
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"), _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Fill, False)> _
        Public Overridable Overloads Function FillBy4(ByVal dataTable As DSDepartmentStock.VAdjustStockHistoryDataTable, ByVal DepartID As Global.System.Nullable(Of Integer), ByVal ItemID As Global.System.Nullable(Of Decimal)) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"), _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.[Select], False)> _
        Public Overridable Overloads Function GetAdjustmentDataByDepatIDAndItemID(ByVal DepartID As Global.System.Nullable(Of Integer), ByVal ItemID As Global.System.Nullable(Of Decimal)) As DSDepartmentStock.VAdjustStockHistoryDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(5)
            If (DepartID.HasValue = True) Then
                Me.Adapter.SelectCommand.Parameters(0).Value = CType(DepartID.Value, Integer)
            Else
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"), _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Fill, False)> _
        Public Overridable Overloads Function FillBy7(ByVal dataTable As DSDepartmentStock.VAdjustStockHistoryDataTable, ByVal ItemName As String) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"), _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.[Select], False)> _
        Public Overridable Overloads Function SelectAdjustByItemName(ByVal ItemName As String) As DSDepartmentStock.VAdjustStockHistoryDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(8)
            If (ItemName Is Nothing) Then
                Me.Adapter.SelectCommand.Parameters(0).Value = Global.System.DBNull.Value
            Else
    ...
    Partial Public Class ITEM_EXPIREDATE_DETAILTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(1).CommandText = "UPDATE       ITEM_EXPIREDATE_DETAIL"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SET                UnitsInStock = @UnitsInSt"& _ 
                "ock, EXPIRE_DATE = @EXPIRE_DATE"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE        (InventoryID = @Original_Inventory"& _ 
        ...
        Public Overloads Overridable Function UpdateItemQTYExpire(ByVal UnitsInStock As Global.System.Nullable(Of Integer), ByVal EXPIRE_DATE As Global.System.Nullable(Of Date), ByVal Original_InventoryID As Integer) As Integer
            ...
            End If
            If (EXPIRE_DATE.HasValue = true) Then
                command.Parameters(1).Value = CType(EXPIRE_DATE.Value,Date)
            Else
                command.Parameters(1).Value = Global.System.DBNull.Value
            End If
            command.Parameters(2).Value = CType(Original_InventoryID,Integer)
