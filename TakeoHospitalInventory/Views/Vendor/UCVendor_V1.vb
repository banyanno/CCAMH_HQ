...
Public Class UCVendor_V1
    ...
    '    If MessageBox.Show("Do you want save new Vendor ?", "New", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = System.Windows.Forms.DialogResult.Yes Then
    ...
    '    If MessageBox.Show("Do you want delete Vendor ?", "Delete", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = System.Windows.Forms.DialogResult.Yes Then
    '        vendor = vendorRepo.GetVenderByID(CInt(txtID.Text))
